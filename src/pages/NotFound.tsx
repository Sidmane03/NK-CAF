...
export default function NotFound() {
  return (
    <main className="flex flex-col items-center justify-center py-32 px-6 min-h-[70vh] text-center bg-cream">
      {/* Fun Icon Container */}
      <div className="w-24 h-24 bg-amber border-2 border-charcoal rounded-full flex items-center justify-center shadow-hard mb-8">
        <Coffee size={48} className="text-charcoal" aria-hidden="true" />
      </div>
      ...
      <Link to="/" className="btn-artisanal rounded-full px-8 py-3 flex items-center gap-2">
        <ArrowLeft size={20} aria-hidden="true" /> Back to Home
      </Link>
    </main>
  );
}